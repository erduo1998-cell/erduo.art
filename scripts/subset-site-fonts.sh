...
for source in index.html reachsurge/index.html site.js portfolio.js business.js motion.js toolbox-scene.js knowledge/index.html knowledge/knowledge.js; do
  test -f "$source"
